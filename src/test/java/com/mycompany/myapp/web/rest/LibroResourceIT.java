...
import com.mycompany.myapp.service.mapper.LibroMapper;
...
class LibroResourceIT {
    ...
    void createLibro() throws Exception {
        ...
        assertThat(testLibro.getCategoria()).isEqualTo(DEFAULT_CATEGORIA);
    }
    ...
    void putExistingLibro() throws Exception {
        ...
        updatedLibro.titulo(UPDATED_TITULO).descripcion(UPDATED_DESCRIPCION).precio(UPDATED_PRECIO).categoria(UPDATED_CATEGORIA);
        ...
        assertThat(testLibro.getCategoria()).isEqualTo(UPDATED_CATEGORIA);
    }
    ...
    void fullUpdateLibroWithPatch() throws Exception {
        ...
        partialUpdatedLibro.titulo(UPDATED_TITULO).descripcion(UPDATED_DESCRIPCION).precio(UPDATED_PRECIO).categoria(UPDATED_CATEGORIA);
